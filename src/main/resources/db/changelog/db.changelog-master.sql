...
ALTER TABLE book_author ADD CONSTRAINT FK_book_author FOREIGN KEY (author_id) REFERENCES author (author_id) ON UPDATE CASCADE ON DELETE RESTRICT;

-- changeset User:1718035475845-8
ALTER TABLE copies ADD CONSTRAINT FK_copies_book FOREIGN KEY (book_id) REFERENCES book (book_id) ON UPDATE CASCADE ON DELETE CASCADE;

-- changeset User:1718035475845-9
ALTER TABLE book_author ADD CONSTRAINT FK_author_book FOREIGN KEY (book_id) REFERENCES book (book_id) ON UPDATE CASCADE ON DELETE CASCADE;
